            ...
            <div className="flex items-center gap-6">
              <Link to="/home" className="flex items-center group">
                <div className="relative">
                  <img src={logoSvg} alt="Moltpump" className="h-16 w-[130px] sm:h-24 sm:w-[160px] transition-transform group-hover:scale-110 object-contain" />
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:flex items-center gap-2">
                <Button
                  ...
                  size="icon"
                  asChild
                  className="h-12 w-12 bg-secondary/50 hover:bg-secondary rounded-lg transition-colors"
                >
                  <a
                    ...
                    className="group"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4.5 w-4.5 fill-muted-foreground group-hover:fill-foreground transition-colors" aria-hidden="true">
                      <path d="M22.25 2h-4.9l-5.2 7.22L8.57 2H1l7.8 11.02L1.5 22h4.9l5.52-7.66L15.93 22H23l-8.1-11.37L22.25 2z"></path>
                    </svg>
                  </a>
                </Button>
                <Button
                ...
                >
                  <a
                    href="https://github.com/Moltpump"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="GitHub"
                    className="group"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 fill-muted-foreground group-hover:fill-foreground transition-colors" aria-hidden="true">
